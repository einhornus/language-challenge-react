...
let examples = [
    {
        ...
        "output": "Значение: [Я <mark>снял<mark> 1000 долларов ...] = (I have <mark>withdrawn</mark> 1000 dollars ...)\n\n" +
            "[Начальная форма слова]: [снять]\n\n" +
            "[снять] ([глагол, совершенный вид]):\n\n" +
            "1. [Отделить предмет одежды или обуви от тела]: [Я <mark>снял</mark> куртку]\n" +
            "2. [Переместить кого-либо с высокого объекта на землю (также в переносном смысле)]: [Мы вчера <mark>сняли</mark> котёнка с дерева]; [Его вчера **сняли** с должности директора]\n" +
            "3. [Получить деньги в кассе или банкомате]: [Я <mark>снял</mark> деньги]\n" +
            "4. [Запечатлеть при помощи соответствующей аппаратуры; сделать фотоизображение, снимок; произвести кино- или видеосъёмку]: [Они <mark>сняли</mark> видео]\n" +
            "5. [Арендовать жильё (также проститутку)]: [Мы <mark>сняли</mark> квартиру в Москве]\n\n" +
    ...
    },
    {
        ...
        "output": "[Значение]: [Ко мне подошла <mark>маленькая</mark> девочка ...] = (A <mark>young</mark> girl approached me ...)\n\n" +
            "[Начальная форма слова]: [маленький]\n\n" +
