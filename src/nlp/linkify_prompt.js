...
let examples = [
    {
        ...
        "word": "снял",
        "output": "Значение: [Я <mark>снял<mark> 1000 долларов ...] = (I have <mark>withdrawn</mark> 1000 dollars ...)<br>" +
            "[Начальная форма слова]: [снять]<br>" +
            "[снять] ([глагол, совершенный вид]):<br>" +
            "1. [Отделить предмет одежды или обуви от тела]: [Я <mark>снял</mark> куртку]<br>" +
            "2. [Переместить кого-либо с высокого объекта на землю (также в переносном смысле)]: [Мы вчера <mark>сняли</mark> котёнка с дерева]; [Его вчера **сняли** с должности директора]<br>" +
            "3. [Получить деньги в кассе или банкомате]: [Я <mark>снял</mark> деньги]<br>" +
            "4. [Запечатлеть при помощи соответствующей аппаратуры; сделать фотоизображение, снимок; произвести кино- или видеосъёмку]: [Они <mark>сняли</mark> видео]<br>" +
            "5. [Арендовать жильё (также проститутку)]: [Мы <mark>сняли</mark> квартиру в Москве]<br>" +
    ...
    },
    {
        ...
        "word": "маленькая",
        "output": "[Значение]: [Ко мне подошла <mark>маленькая</mark> девочка ...] = (A <mark>young</mark> girl approached me ...)<br>" +
            "[Начальная форма слова]: [маленький]<br><" +
            "[маленький] ([прилагательное]):<br>" +
            "1. [небольшой]: [<mark>маленький</mark> дом]<br>" +
            "2. [юный]: [<mark>маленький</mark> ребенок]<br>" +
